...
#tMap = pygame.image.load(".\Images\RaceTrack_500x500.png")
#innerMap = pygame.image.load(".\Images\RaceTrack_500x500_trackMap.png")
outerMap = pygame.image.load(".\Images\RaceTrack_500x500_grayMap_OR.png")
...
def findObjectCenter():
    object_Rect.center = (((width-65)/2) + (0) - x, ((height/-65)/2) + (0) - y)

object_Rect = testObject.get_rect()
object_Rect.width = 65
object_Rect.height = 65
findObjectCenter()

#innerMapS = pygame.transform.scale_by(innerMap , (10))
outerMapS = pygame.transform.scale_by(outerMap , (10))
#tMapS = pygame.transform.scale_by(tMap , (10))
Backround_Center = (((width-5000)/2) - x, ((height-5000)/2)- y)
...
while running:
    ...
    #screen.blit(innerMapS, (Backround_Center))
    ...
    #screen.blit(centeringTestImage, (((width-64)/2), ((height-64)/2)))
